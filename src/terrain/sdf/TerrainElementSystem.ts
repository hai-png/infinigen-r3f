...
import { TerrainElement, ElementEvalResult, CompositionOperation } from './TerrainElementBase';
...
// Re-export base types from the extracted module to break circular dependency
export { TerrainElement, ElementEvalResult, CompositionOperation } from './TerrainElementBase';
