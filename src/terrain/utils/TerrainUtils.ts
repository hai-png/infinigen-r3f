...
export class TerrainUtils {
   ...
   */
  public static createWaterConfig(config: Partial<WaterConfig> = {}): WaterConfig {
    return {
      level: 0.3,
      color: 0x4488ff,
      opacity: 0.7,
   ...
   */
  public static generateShorelineMask(
    heightMap: HeightMap,
    width: number,
    height: number,
    waterLevel: number,
