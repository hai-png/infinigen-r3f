...
const DEFAULT_DESCRIPTORS: Record<SurfaceAttributeType, SurfaceMaterialDescriptor[]> = {
  [SurfaceAttributeTypes.GroundCollection]: [
    {
      ...
      weight: 3.0,
      params: { color: 0x6b4423, roughness: 0.95, metalness: 0.0, normalScale: 0.8, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.15, frequency: 0.05, octaves: 4, lacunarity: 2.0, persistence: 0.5 },
    },
    {
      id: 'grass',
      name: 'Grassland',
      surfaceType: SurfaceType.Displacement,
      weight: 4.0,
      params: { color: 0x4a7c30, roughness: 0.85, metalness: 0.0, normalScale: 0.6, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.05, frequency: 0.04, octaves: 3, lacunarity: 2.0, persistence: 0.5 },
    },
    {
      id: 'moss',
      name: 'Moss',
      surfaceType: SurfaceType.Displacement,
      weight: 1.5,
      params: { color: 0x3d6b2e, roughness: 0.9, metalness: 0.0, normalScale: 0.7, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.03, frequency: 0.08, octaves: 3, lacunarity: 2.0, persistence: 0.5 },
    },
    {
      id: 'forest_floor',
      name: 'ForestFloor',
      ...
      weight: 2.0,
      params: { color: 0x4a5c30, roughness: 0.9, metalness: 0.0, normalScale: 0.7, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.15, frequency: 0.08, octaves: 4, lacunarity: 2.0, persistence: 0.5 },
    },
  ],
  [SurfaceAttributeTypes.MountainCollection]: [
    {
      ...
      surfaceType: SurfaceType.Displacement,
      weight: 4.0,
      params: { color: 0x7a6e60, roughness: 0.95, metalness: 0.0, normalScale: 1.0, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.5, frequency: 0.1, octaves: 5, lacunarity: 2.0, persistence: 0.5 },
    },
    {
      id: 'cliff_face',
      name: 'CliffFace',
      surfaceType: SurfaceType.Displacement,
      weight: 2.0,
      params: { color: 0x8a7e70, roughness: 0.9, metalness: 0.0, normalScale: 1.0, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.3, frequency: 0.15, octaves: 4, lacunarity: 2.0, persistence: 0.5 },
    },
    {
      id: 'scree',
      name: 'Scree',
      surfaceType: SurfaceType.SDFPerturb,
      weight: 1.0,
      params: { color: 0x9a8e80, roughness: 0.95, metalness: 0.0, normalScale: 0.9, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.2, frequency: 0.12, octaves: 3, lacunarity: 2.0, persistence: 0.5 },
    },
  ],
  [SurfaceAttributeTypes.RockCollection]: [
    {
      ...
      surfaceType: SurfaceType.Displacement,
      weight: 3.0,
      params: { color: 0x8a8070, roughness: 0.9, metalness: 0.0, normalScale: 0.9, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.15, frequency: 0.2, octaves: 3, lacunarity: 2.0, persistence: 0.5 },
    },
    {
      id: 'boulder',
      name: 'Boulder',
      surfaceType: SurfaceType.Displacement,
      weight: 2.0,
      params: { color: 0x7a7060, roughness: 0.95, metalness: 0.0, normalScale: 1.0, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.3, frequency: 0.1, octaves: 4, lacunarity: 2.0, persistence: 0.5 },
    },
  ],
  [SurfaceAttributeTypes.Snow]: [
    {
      ...
      surfaceType: SurfaceType.Displacement,
      weight: 1.0,
      params: { color: 0xe8ecf4, roughness: 0.6, metalness: 0.0, normalScale: 0.3, opacity: 1.0, transparent: false },
  ...
  [SurfaceAttributeTypes.Beach]: [
    {
      ...
      surfaceType: SurfaceType.Displacement,
      weight: 3.0,
      params: { color: 0xc2b87a, roughness: 0.95, metalness: 0.0, normalScale: 0.8, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.02, frequency: 0.03, octaves: 3, lacunarity: 2.0, persistence: 0.5 },
    },
    {
      id: 'wet_sand',
      name: 'WetSand',
      surfaceType: SurfaceType.Displacement,
      weight: 1.0,
      params: { color: 0x9a905a, roughness: 0.7, metalness: 0.0, normalScale: 0.6, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.01, frequency: 0.02, octaves: 2, lacunarity: 2.0, persistence: 0.5 },
    },
  ],
  [SurfaceAttributeTypes.Eroded]: [
    {
      ...
      surfaceType: SurfaceType.Displacement,
      weight: 2.0,
      params: { color: 0x9a9080, roughness: 0.95, metalness: 0.0, normalScale: 1.0, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.3, frequency: 0.12, octaves: 4, lacunarity: 2.0, persistence: 0.5 },
    },
    {
      id: 'weathered_stone',
      name: 'WeatheredStone',
      surfaceType: SurfaceType.SDFPerturb,
      weight: 1.0,
      params: { color: 0xaa9a8a, roughness: 0.9, metalness: 0.0, normalScale: 0.8, opacity: 1.0, transparent: false },
      displacement: { amplitude: 0.2, frequency: 0.08, octaves: 3, lacunarity: 2.0, persistence: 0.5 },
    },
  ],
  [SurfaceAttributeTypes.Lava]: [
    {
      ...
      surfaceType: SurfaceType.Displacement,
      weight: 1.0,
      params: { color: 0xff4400, roughness: 0.3, metalness: 0.1, normalScale: 0.5, opacity: 1.0, transparent: false },
  ...
  [SurfaceAttributeTypes.LiquidCollection]: [
    ...
    },
    {
      ...
      surfaceType: SurfaceType.Displacement,
      weight: 1.0,
      params: { color: 0x0a2640, roughness: 0.15, metalness: 0.0, normalScale: 0.2, opacity: 0.9, transparent: true },
      displacement: { amplitude: 0.03, frequency: 0.3, octaves: 2, lacunarity: 2.0, persistence: 0.5 },
    },
    {
      id: 'murky_water',
      name: 'MurkyWater',
      surfaceType: SurfaceType.Displacement,
      weight: 0.5,
      params: { color: 0x2a4030, roughness: 0.3, metalness: 0.0, normalScale: 0.4, opacity: 0.9, transparent: true },
      displacement: { amplitude: 0.02, frequency: 0.4, octaves: 2, lacunarity: 2.0, persistence: 0.5 },
    },
  ],
};
