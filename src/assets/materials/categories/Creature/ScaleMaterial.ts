...
export class ScaleMaterial {
  private config: ScaleMaterialConfig;
  ...
  private generateRoundScales(x: number, y: number, size: number, freq: number): number {
    const u = x / size;
    const v = y / size;
  ...
  private generateHexagonalScales(x: number, y: number, size: number, freq: number): number {
    const u = x / size;
    const v = y / size;
  ...
  private generateDiamondScales(x: number, y: number, size: number, freq: number): number {
    const u = x / size;
    const v = y / size;
  ...
  private generateJaggedScales(x: number, y: number, size: number, freq: number): number {
    const u = x / size;
    const v = y / size;
