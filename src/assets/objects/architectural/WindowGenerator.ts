...
export class WindowGenerator extends BaseObjectGenerator<WindowParams> {
  ...
  private createPanes(params: WindowParams): Group[] {
    const panes: Group[] = [];
  ...
  private createMullions(params: WindowParams): Group[] {
    const mullions: Group[] = [];
  ...
  private createSill(params: WindowParams): Group {
