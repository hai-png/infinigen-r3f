export type { LampBase, LampParams } from './LampBase';
export type { CeilingLights, CeilingLightParams } from './CeilingLights';
export type { FloorLamps, FloorLampParams } from './FloorLamps';
