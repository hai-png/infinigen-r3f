...
export class GroundCoverGenerator extends BaseObjectGenerator<GroundCoverConfig> {
  ...
  private createLeaves(config: GroundCoverConfig, rng: SeededRandom): THREE.InstancedMesh {
  ...
  private createTwigs(config: GroundCoverConfig, rng: SeededRandom): THREE.InstancedMesh {
  ...
  private createPebbles(config: GroundCoverConfig, rng: SeededRandom): THREE.InstancedMesh {
